...
private ["_buildcheck","_finished","_isfriendly","_isowner","_nearestPole","_IsNearPlot","_plotcheck","_canRemove","_isOwnerOfObj","_objOwnerID","_obj","_locationPlayer","_objectID","_objectUID","_location1","_location2"];
